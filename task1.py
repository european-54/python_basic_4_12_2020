...
декоратором @staticmethod, должен проводить валидацию числа, месяца и года (например,
...
today = Data('1 - 1 - 2021')
print(today)
print(Data.valid(32, 10, 2020))
print(today.valid(7, 15, 2011))
print(Data.extract('1 - 11 - 2020'))
print(today.extract('7 - 3 - 2012'))
